  ...
  return (
    <section className="container mx-auto flex flex-col items-center mt-20">
      <Fade direction="up" triggerOnce>
        <h1 className="text-5xl text-theme-blue text-center font-bold">Are you looking for a job opportunity?</h1>
      </Fade>
      ...
      <Fade bottom triggerOnce>
        <Button href="/project" type="link" className="flex flex-grow-0 w-36 h-12 sm:w-40 sm:h-14 lg:w-44 lg:h-16 xl:w-36 xl:h-12 text-[#01a6a5] px-5 border border-[#01a6a5] items-center mt-14 rounded-full justify-center transition duration-300 hover:bg-[#016a69] hover:text-white">
