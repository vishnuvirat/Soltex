...
export default function AllPortfolio({ data }) {
  const [selectedIndex, setSelectedIndex] = useState(0); // Initialize selectedIndex state
    ...
    <Fade bottom>
      <section className="container mx-auto">
        <Tabs
          ...
          onSelect={(index) => setSelectedIndex(index)} // Update selectedIndex on tab select
        >
          <TabList>
            <div className="flex flex-row mb-5">
              ...
              <Tab>
                <button
                  className={`font-normal px-5 py-2 mr-3 text-lg border border-[#01a6a5] rounded-full transition duration-300 focus:outline-none ${
                    selectedIndex === 0
                      ? 'bg-[#016a69] text-white'
                      : 'text-[#01a6a5] hover:bg-[#016a69] hover:text-white'
                  }`}
                >
                  All
                </button>
              ...
              <Tab>
                <button
                  className={`font-normal px-8 py-2 text-lg border border-[#01a6a5] rounded-full transition duration-300 focus:outline-none ${
                    selectedIndex === 2
                      ? 'bg-[#016a69] text-white'
                      : 'text-[#01a6a5] hover:bg-[#016a69] hover:text-white'
                  }`}
