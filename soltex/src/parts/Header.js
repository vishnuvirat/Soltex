  ...
  return (
    <header className="header">
      <div className="flex justify-between px-4 lg:px-0">
        ...
        <button className="block text-[#016a69] lg:hidden focus:outline-none" onClick={() => setIsCollapse(!isCollapse)}>
      ...
      <ul className="hidden text-[#01a6a5] tracking-widest items-center lg:flex flex-row mt-0">
        <li>
          <Button
        ...
        <li>
          <Button
            className="font-medium text-lg mx-auto ml-3 px-6 py-2 bg-[#01a6a5] text-white rounded-full border-2 hover:bg-[#016a69] border-[#016a69] transition duration-200"
            type="link"
        ...
        <div className="transition duration-300 ease-in data-[closed]:opacity-0">
          ...
          <ul className="z-50 flex flex-col text-theme-blue tracking-widest my-6 absolute bg-white w-full border-b-2 border-gray-300 lg:hidden">
            ...
            <li className="mx-auto my-9 bg-white">
              <Button
                className="font-bold mx-auto px-5 py-2 bg-[#01a6a5] text-white rounded-full border-2 hover:bg-[#016a69] border-[#016a69] transition duration-200"
                type="link"
                href="/discuss-project"
              >
                Contact Us
